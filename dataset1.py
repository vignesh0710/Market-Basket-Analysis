...
dframe_main = pd.read_table('/Users/vigneshsureshbabu/Desktop/maybenew/transformed_dataset.csv',sep =',')
dframe = pd.read_table('/Users/vigneshsureshbabu/Desktop/maybenew/transformed_dataset.csv',sep =',')
##print(dframe)
...
##########################################################################################################
#rule generation for part (d) & part(e)
