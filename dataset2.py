...
dframe_main = pd.read_table('/Users/vigneshsureshbabu/Desktop/maybenew/data/mushroom_dataset.csv',sep =',')
p = len(dframe_main.columns)
print(p)

dframe = pd.read_table('/Users/vigneshsureshbabu/Desktop/maybenew/data/mushroom_dataset.csv',sep =',')
...
#calculating the number of maximal and frequent itemsets
